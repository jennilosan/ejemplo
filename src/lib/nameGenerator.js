...
export const classSuffixes = {
  Warrior: ['the Strong', 'Shieldbearer', 'of the Blade', 'Ironfist', 'Battleborn', 'the Relentless'],
  Mage: ['Fireweaver', 'Arclight', 'the Spellbound', 'the Mystic', 'Stormbringer', 'Voidwalker'],
  Rogue: ['of the Shadows', 'Whispercloak', 'the Quick', 'Nightstalker', 'Daggerfall', 'Silentblade']
};
...
export function generateName(race, charClass) {
  ...
  const suffix = classSuffixes[charClass][Math.floor(Math.random() * classSuffixes[charClass].length)];
